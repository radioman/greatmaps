...
/**
 * An API 11+ implementation of {@link SystemUiHider}. Uses APIs available in Honeycomb and later (specifically {@link View#setSystemUiVisibility(int)}) to show and hide the system UI.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class SystemUiHiderHoneycomb extends SystemUiHiderBase
{
    /**
    ...
    /**
     * Flags to test against the first parameter in {@link android.view.View.OnSystemUiVisibilityChangeListener#onSystemUiVisibilityChange(int)} to determine the system UI visibility state.
     */
