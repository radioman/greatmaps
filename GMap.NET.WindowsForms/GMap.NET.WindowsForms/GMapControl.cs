            ...
            if(gxOff != null && backBuffer != null)
            {
...
#endif
               {
                  ...
                  if(IsRotated)
                  {
                     ...
                     gxOff.TextRenderingHint = TextRenderingHint.AntiAlias;
                     gxOff.SmoothingMode = SmoothingMode.AntiAlias;

                     gxOff.TranslateTransform((float)(Core.Width / 2.0), (float)(Core.Height / 2.0));
                     gxOff.RotateTransform(-Bearing);
                     gxOff.TranslateTransform((float)(-Core.Width / 2.0), (float)(-Core.Height / 2.0));
